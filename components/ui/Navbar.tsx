...
const NavBar = () => {
  ...
  return (
    <div className="fixed top-4 left-1/2 transform -translate-x-1/2 flex justify-center z-50">
      ...
      >
        <div className="flex items-center space-x-1 text-[0.875rem] py-2 px-4">
