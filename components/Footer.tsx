...
const navigation: {
  ...
  social: [
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/Khalifa004',
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/in/khalifa-seck/',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    <footer className="w-full">
      ...
      <div className="grid items-center justify-center gap-4 px-4 text-center md:px-6 w-full py-4">
          ...
          <div className="space-y-3">
              ...
              <a
  href="mailto:Khalifa.seck@protonmail.com"
  className="inline-block rounded-lg  text-background px-3 py-1 text-sm"
><PulsatingButton>
  Contact</PulsatingButton>
</a>
              </div>
       
        
              <h2 className="text-3xl font-bold dark:text-[#BEF264] tracking-tighter sm:text-5xl">
                Get in Touch
              </h2>
      ...
      <div className="mx-auto w-full max-w-6xl px-4 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-5 flex justify-center space-x-6">
          {navigation.social.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="text-neutral-700 hover:text-zinc-800 dark:text-zinc-300"
            >
        ...
        <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-100">
          &copy; {new Date().getFullYear()} Khalifa Studio. All rights reserved.
        </p>
      </div>
    </footer>
  )
