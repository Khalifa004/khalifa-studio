...
export default function NorthStarCaseStudy() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-background text-gray-600 selection:bg-red-100 selection:text-red-900 font-sans antialiased overflow-x-clip">
        ...
        <div className="grid lg:grid-cols-[1fr_250px] gap-12 items-start relative">
          ...
          <div className="w-full min-w-0">
            ...
            <main className="space-y-32 md:space-y-48 w-full lg:pb-32">
              ...
              {/* Overview / Problem */}
              <Section id="the-challenge" className="grid md:grid-cols-[1fr_2fr] gap-12 md:gap-24">
                <div>
              ...
              {/* Target Audience */}
              <Section id="target-audience" className="space-y-16">
              ...
              <Section id="visual-interface" className="space-y-16">
                <div className="max-w-xl">
              ...
              {/* Smart Booking / UI UX */}
              <Section id="smart-booking" className="grid md:grid-cols-2 gap-12 md:gap-24 items-start">
                <div className="space-y-12">
                  <div>
              ...
              <Section id="business-model" className="space-y-12">
          ...
          <CaseStudySidebar
            sections={[
              ...
              { id: "visual-interface", label: "Visual Interface" },
