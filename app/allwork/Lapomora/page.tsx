...
import { ArrowLeft, Clock, BarChart, CheckSquare, Smartphone, ExternalLink } from "lucide-react";
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#FAFAFA] text-gray-600 selection:bg-black/5 selection:text-black font-sans antialiased overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-20%] right-[-10%] w-[60%] h-[60%] bg-lime-100/40 blur-[150px] rounded-full mix-blend-multiply opacity-50" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-emerald-100/40 blur-[150px] rounded-full mix-blend-multiply opacity-50" />
        ...
        <main className="space-y-32">
          ...
          <Section>
            <div className="flex items-center justify-between mb-12">
              <h2 className="text-2xl font-medium text-gray-900">Core Features</h2>
              <div className="h-px w-32 bg-black/5" />
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Clock, title: "Intuitive Timer", desc: "Circular progress with color psychology." },
                { icon: BarChart, title: "Analytics", desc: "Visual productivity data tracking." },
                { icon: CheckSquare, title: "Tasks", desc: "Integrated to-do list for flow." },
                { icon: Smartphone, title: "Sync", desc: "Seamless cross-device experience." }
              ].map((f, i) => (
                <Card key={i}>
          ...
          <Section>
            <div className="flex items-center justify-between mb-12">
              <h2 className="text-2xl font-medium text-gray-900">Tech Stack</h2>
              <div className="h-px w-32 bg-black/5" />
            </div>
          ...
          <Section className="pt-24 border-t border-black/5">
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h3 className="text-2xl font-medium text-gray-900 mb-6">Impact</h3>
